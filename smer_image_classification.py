...
class ImageClassifier:
    ...
    def _local_image_description(self, file: Union[PathLike, str], prompt: str) -> Union[str, None]:
        """
        Generate image description using a local model.
        :param file: Path to the image file.
        :param prompt: Text instruction for the local model.
        :return: Text description generated by the local model.
        """
        try:
            # Use the local model to process the image and generate a description
            encoded_image = self.encode_image(file)
            description = self.local_model.generate_description(encoded_image, prompt)
            return description
        except Exception as e:
            print(f'Error: {e}')
            return None
